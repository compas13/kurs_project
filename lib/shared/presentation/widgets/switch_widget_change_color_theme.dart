...
class SwitchWidgetChangeColorTheme extends StatefulWidget {
  //final String nameData;
  final dynamic state; // провайдер appTheme или appSettings

  const SwitchWidgetChangeColorTheme({super.key, required this.state});

  @override
  State<SwitchWidgetChangeColorTheme> createState() => _SwitchWidgetChangeColorThemeState();
}

class _SwitchWidgetChangeColorThemeState extends State<SwitchWidgetChangeColorTheme> {
