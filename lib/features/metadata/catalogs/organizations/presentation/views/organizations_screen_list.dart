...
import '../widgets/organizations_list_view.dart';

class OrganizationsScreenList extends StatelessWidget {
  final String viewMode; //list - форма списка/ select - форма выбора
  const OrganizationsScreenList({super.key, required this.viewMode});
