...
import '../widgets/purchase_documents_list_view.dart';

class PurchaseDocumentsScreenList extends StatelessWidget {
  final String viewMode; //list - форма списка/ select - форма выбора
  const PurchaseDocumentsScreenList({super.key, required this.viewMode});
