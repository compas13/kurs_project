...
class SaleDocumentsState extends ChangeNotifier {
  int id = 0;
  ...
  void initProvider(SaleDocumentsModel saleDocumentsModel) {
    if (needInit) {
      if (saleDocumentsModel.id != 0) {
        needInit = false;
        id = saleDocumentsModel.id;
        date = saleDocumentsModel.date;
        organization = saleDocumentsModel.organization;
        customer = saleDocumentsModel.customer;
        product = saleDocumentsModel.product;
        quantity = saleDocumentsModel.quantity;
        price = saleDocumentsModel.price;
        sum = saleDocumentsModel.sum;
  ...
  SaleDocumentsModel stateToModel() {
