...
class SaleDocumentsCardInList extends StatelessWidget {
  final SaleDocumentsModel saleDocumentsModel;
  final String viewMode;

  const SaleDocumentsCardInList({super.key, required this.saleDocumentsModel, required this.viewMode});
    ...
    return GestureDetector(
      onTap: () {
        if (viewMode == 'select') {
          ...
          context.pop(saleDocumentsModel);
        } else {
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 16),
              Text(
                '№${saleDocumentsModel.id} от ${DateFormat('dd.MM.yyyy').format(saleDocumentsModel.date)}',
                style: TextStyle(
                  fontSize: 14,
              ...
              Text(
                formatNumber(saleDocumentsModel.sum, 2),
                style: TextStyle(
                  fontSize: 20,
